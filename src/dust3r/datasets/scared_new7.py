...
class SCARED_Multinew7(BaseMultiViewDataset):
    def __init__(self, *args, ROOT, **kwargs):
        ...
        self.scenes_to_use = [
            # 训练集场景 (使用_fast后缀)
            "dataset1_keyframe1_fast",
            "dataset1_keyframe2_fast", 
            "dataset1_keyframe3_fast",
            "dataset2_keyframe1_fast",
            "dataset2_keyframe2_fast",
            "dataset2_keyframe3_fast",
            # 注意：dataset2_keyframe4被排除
            "dataset3_keyframe1_fast",
            "dataset3_keyframe2_fast", 
            "dataset3_keyframe3_fast",
            "dataset3_keyframe4_fast",
            "dataset6_keyframe1_fast",
            "dataset6_keyframe2_fast",
            "dataset6_keyframe3_fast", 
            "dataset6_keyframe4_fast",
            "dataset7_keyframe1_fast",
            "dataset7_keyframe2_fast",
            "dataset7_keyframe3_fast",
            # 注意：dataset7_keyframe4被排除

            # 验证集场景 (使用_val后缀)
            "dataset1_keyframe1_val",
            "dataset1_keyframe2_val", 
            "dataset1_keyframe3_val",
            "dataset2_keyframe1_val",
            "dataset2_keyframe2_val",
            "dataset2_keyframe3_val",
            # 注意：dataset2_keyframe4被排除
            "dataset3_keyframe1_val",
            "dataset3_keyframe2_val", 
            "dataset3_keyframe3_val",
            "dataset3_keyframe4_val",
            "dataset6_keyframe1_val",
            "dataset6_keyframe2_val",
            "dataset6_keyframe3_val", 
            "dataset6_keyframe4_val",
            "dataset7_keyframe1_val",
            "dataset7_keyframe2_val",
            "dataset7_keyframe3_val",
            # 注意：dataset7_keyframe4被排除
        ]
    ...
    def _get_views(self, idx, resolution, rng, num_views):
        ...
        for v, view_idx in enumerate(image_idxs):
            ...
            img_mask, ray_mask = self.get_img_and_ray_masks(
                self.is_metric, v, rng, p=[0.0, 0.0, 1.0]
            )
